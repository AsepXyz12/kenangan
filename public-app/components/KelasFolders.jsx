...
// nyambung gaya visualnya waktu folder ini dibuka.
      ...
      {classes.map((kelas, i) => {
        ...
        return (
          <Link
            ...
            className="polaroid relative block w-full max-w-[220px] mx-auto rotate-[var(--r)]"
          ...
          >
            ...
            <p className="mt-2 text-center font-display italic text-lg text-emerald truncate">
              {kelas.name}
            </p>
            {wali.length > 0 && (
              <p className="text-center font-stamp text-[10px] uppercase tracking-wide text-ink/50 mt-0.5 truncate">
