      ...
      {!authed ? (
        ...
        <div className="mt-8">
          <p className="text-sm text-ink/60 mb-6">
            Kelola daftar guru & mapel, wali kelas, kelas aktif, dan murid
            beserta fotonya. Klik &quot;Upload foto&quot; di kartu murid untuk
            unggah satu per satu — tidak perlu semuanya sekaligus. Kelas yang
            sudah jadi alumni dikelola terpisah di{" "}
            <a href="/alumni" className="underline text-accent">
              Dashboard Alumni
            </a>
            .
          </p>
