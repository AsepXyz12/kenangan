...
export async function POST(request: NextRequest) {
  try {
    ...
    // Surface the real cause (e.g. DB unreachable, missing JWT_SECRET) as JSON
    // instead of letting it crash into an HTML 500 page that breaks res.json()
    // on the client and shows a generic "network error" message.
